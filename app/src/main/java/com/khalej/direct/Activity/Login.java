...
public class Login extends AppCompatActivity {
    AppCompatButton Naccount,car,servcies;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        car=findViewById(R.id.textViewLinkRegistercar);
        servcies=findViewById(R.id.appCompatButtonRegisterservcies);
        ...
        car.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edt.apply();
                startActivity(new Intent(Login.this,Registration_car.class));
            }
        });
        servcies.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edt.putFloat("lnglocation",(float)lng);
                edt.apply();
                startActivity(new Intent(Login.this,Registration_servcies.class));
            }
        });
