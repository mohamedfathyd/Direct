...
SearchView searchView;
        ...
        toolbar.setNavigationOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(MapsActivity.this, SubCategory.class);
                        intent.putExtra("latFrom", 0.0);
                        intent.putExtra("lngFrom", 0.0);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(sharedpref.getFloat("latlocation",0)==0){
            ...
            Toast.makeText(MapsActivity.this,"من فضلك تأكد ان الخريطة تحديد الموقع يعمل بشكل جيد عن طريق فتح جوجل ماب وغلقه لكي يمكننا تحديد موقعك الحالي",Toast.LENGTH_LONG).show();
    ...
    public void mylocation(final LatLng latLng){
        ...
        new AlertDialog.Builder(MapsActivity.this)
                .setTitle("direct App")
                .setMessage("هل هذا هو موقع بدأ رحلة النقل ؟")
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Intent intent=new Intent(MapsActivity.this,SubCategory.class);
                        intent.putExtra("latFrom",latLng.latitude);
                        intent.putExtra("lngFrom",latLng.longitude);
                        intent.putExtra("latTo",latTo);
                        intent.putExtra("lngTo",lngTo);
                        intent.putExtra("id",getCategory_id);
                        intent.putExtra("numberSets",gender_id);
